...
function Add-TicketNote {
    ...
    Invoke-RestMethod -uri "https://cwticketorchestration.azurewebsites.net/api/CWTicketManagement?code=Zc2ywLe3yD7b_ILveDE0stkFnARoeNv17GBbrvESZPWLAzFufBIjOg==" -Method Post -Body $UpdateBody
}
...
function Check-Ticket ($ticketID){
    ...
    try {
        Invoke-WebRequest -Uri "https://cwticketorchestration.azurewebsites.net/api/CWTicketManagement?code=Zc2ywLe3yD7b_ILveDE0stkFnARoeNv17GBbrvESZPWLAzFufBIjOg==" -Body $body -Method post | Out-Null
    }
        catch {
